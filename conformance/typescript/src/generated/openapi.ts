...
import type { operations } from "./openapi.operations.js";
export type { operations } from "./openapi.operations.js";
/**
...
export interface components {
    schemas: {
        ...
        "session-metadata.schema": {
            ...
            /** @constant */
            schema_version: "session-metadata-v29-contract"; server_contract_version: string; session_id: string;
        ...
        "proposal-payload--weapon_skill_modifier.schema": {
            ...
            source_id: components["schemas"]["proposal-payload--identifier.schema"];
            scope: {
                characteristics: ("ballistic_skill" | "weapon_skill")[]; target_ids: null;
            };
            /** @enum {unknown} */
        ...
        "proposal-payload--weapon_profile.schema": {
            ...
            skill_modifiers?: components["schemas"]["proposal-payload--weapon_skill_modifier.schema"][];
        ...
        "session-command-outcome.schema": {
            ...
            /** @constant */
            schema_version: "session-command-outcome-v29-contract"; session: components["schemas"]["session-metadata.schema"];
        } & ({
            /** @constant */
            accepted?: true;
            /** @constant */
        ...
        "replay-metadata.schema": {
            ...
            /** @constant */
            schema_version: "replay-artifact-v23-ingress-placement-history";
