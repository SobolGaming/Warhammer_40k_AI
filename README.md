...
Current roadmap implementation status: phases 1-14F are complete. Phase 14E includes Benefit of Cover and Plunging Fire BS modifiers, mandatory Invulnerable Saves with no save-kind adapter choice, the 11th Edition allocation-group host, defender allocation-order decisions, grouped save-before-damage resolution, low-to-high failed-save damage ordering, normal-damage-before-routed-mortal ordering, Precision selection by Character allocation group identity, and derived terrain objectives that require terrain-area containment rather than marker-radius contribution. Phase 14F completes the Shooting phase cutover with finite shooting-type selection, grouped attack resolution, Normal/Assault/Close-quarters/Indirect/Snap routing, Indirect and Snap Hit-roll reroll bans, and the Shooting-phase Mission Action start lock.
