...
CORE V1 refers to the previous
[`SobolGaming/Warhammer40k_AI`](https://github.com/SobolGaming/Warhammer40k_AI)
program. It is a reference implementation, not a source to copy wholesale. For
each phase below, inspect the listed CORE V1 areas before implementation,
identify the invariants and algorithms worth preserving, and then implement them
in CORE V2 using strict typed data, fail-fast validation, replay-safe payloads,
and current import boundaries.
