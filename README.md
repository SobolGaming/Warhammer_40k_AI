...
Current roadmap implementation status: phases 1-14E are complete, including Aircraft-policy movement budgets, persisted Hover movement policy, the triggered/surge movement foundation, the Movement phase completion gate, the movement/pathing/terrain profiling budget gate, Movement audit hardening, source-backed Chapter Approved 2025-26 mission pack/scoring/action data, objective control geometry, the Command phase body, the adapter/proposal scaffold, mission action state, primary/secondary scoring, Tactical discard and supported Mission Action start decision flows, end-of-turn cleanup, battle-round/game-end scoring windows, VP caps, final scoring audit payloads, winner/draw determination, timing windows, reaction queue, sequencing, persisting effects, the Command Point ledger, the source-backed Stratagem framework, phase-resolvable Core Stratagems, the ability handler registry, the terrain visibility/line-of-sight/cover foundation, shooting target selection and weapon declaration, the hit/wound/allocation/save/damage attack sequence host, Phase 13D weapon ability plus supported shooting-coupled Core Stratagem coverage including Fire Overwatch's Movement-phase out-of-phase shooting host, Phase 13E destroyed-model removal records plus shared-path optional destruction reaction choices for shoot-on-death/fight-on-death sources and mandatory pre-removal Deadly Demise resolution, including Deadly Demise secondary casualties, the Phase 13F Shooting phase completion gate with explicit skipped-unit accounting, the Phase 14A 11th Edition source identity and retired-identity audit, the Phase 14B timing-window, active-player, and End of Opponent's Movement phase reaction cutover, the Phase 14C shared primitives cutover for 2"/5" Engagement Range, one-neighbor plus 9"/5" coherency, free rotations, typed dash characteristics, Detection Range, Battle-shocked OC/action restrictions, and unit-level Hazardous mortal-wound allocation, the Phase 14D movement, terrain, objectives, and actions cutover for Move Units reserve arrivals, Take to the Skies finite/proposal movement modes, explicit Fall Back modes, Monster/Vehicle traversal gates, terrain-objective control with marker fallback, non-blocking objective markers, and engine-owned Mission Action cancellation, and the Phase 14E attack sequence/allocation cutover for BS-based cover and Plunging Fire, mandatory Invulnerable Saves with no save-kind adapter choice, pool-scoped Precision Character-group allocation, and terrain-objective containment.
