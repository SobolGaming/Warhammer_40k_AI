...
Current roadmap implementation status: phases 1-10U are complete, including Aircraft-policy movement budgets, persisted Hover movement policy, the triggered/surge movement foundation, the Movement phase completion gate, and the movement/pathing/terrain profiling budget gate. Phase 11A is the next planned build slice.
