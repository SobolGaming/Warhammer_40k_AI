...
18E session protocol, and Phase 18F optimistic-concurrency command protocol for
the reference adapter server. `schemas/` is the only authoritative JSON Schema
