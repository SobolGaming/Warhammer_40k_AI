...
This directory is the canonical, language-neutral Phase 18D contract and Phase
18E session protocol for the reference adapter server. `schemas/` is the only authoritative JSON Schema
...
session/engine identities, participant assignments, lifecycle metadata,
monotonic revisions, viewer checkpoints, start/close transitions, and one
coherent bounded post-submission drain result.
...
representative session-create, engine-create, finite, and parameterized requests:
