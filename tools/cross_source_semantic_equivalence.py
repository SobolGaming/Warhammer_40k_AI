...
def faction_semantic_equivalence_markdown(
    ...
    *,
    ...
    lines = [
        ...
        "",
        (
            "This section is generated from the repository-wide semantic audit. It audits "
            "portable structured RuleIR and exact-text equivalence; it is not a complete view "
            "of source-local runtime wiring. A `blocked_structured_semantics` label means this "
            "audit cannot transfer that source text through shared RuleIR. A source-local "
            "named runtime consumer can still provide execution evidence in the sections above."
        ),
        "",
