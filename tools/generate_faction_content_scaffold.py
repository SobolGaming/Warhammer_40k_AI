...
SHADOW_LEGION_STRATAGEMS_MODULE_PATH = (
    f"{BASE_IMPORT_PATH}.chaos_daemons.detachments.shadow_legion.stratagems"
)
...
BLOOD_LEGION_ENHANCEMENTS_MODULE_PATH = (
    f"{BASE_IMPORT_PATH}.chaos_daemons.detachments.blood_legion.enhancements"
)
...
IMPLEMENTED_CONTRIBUTION_IDS_BY_MODULE_PATH = {
    ...
    THOUSAND_SONS_ARMY_RULE_MODULE_PATH: (
    ...
    SHADOW_LEGION_STRATAGEMS_MODULE_PATH: (
        "warhammer_40000_11th:chaos_daemons:detachment:shadow_legion:stratagems"
    ),
    DAEMONIC_INCURSION_RULE_MODULE_PATH: (
    ...
    BLOOD_LEGION_ENHANCEMENTS_MODULE_PATH: (
        "warhammer_40000_11th:chaos_daemons:detachment:blood_legion:enhancements"
    ),
    CAVALCADE_OF_CHAOS_RULE_MODULE_PATH: (
        "warhammer_40000_11th:chaos_daemons:detachment:cavalcade_of_chaos:rule"
    ),
    f"{WARPTIDE_MODULE_PATH}.manifest": (
        "warhammer_40000_11th:chaos_daemons:detachment:warptide:manifest"
    ),
    f"{WARPTIDE_MODULE_PATH}.rule": ("warhammer_40000_11th:chaos_daemons:detachment:warptide:rule"),
    f"{WARPTIDE_MODULE_PATH}.enhancements": (
        "warhammer_40000_11th:chaos_daemons:detachment:warptide:enhancements"
    ),
...
def _detachment_manifest_content(*, faction_module: str, detachment_module: str) -> str:
    contribution_id = contribution_id_for_module_path(
        f"{BASE_IMPORT_PATH}.{faction_module}.detachments.{detachment_module}.manifest"
    )
    return (
        f"{_generated_header()}\n"
        "from warhammer40k_core.engine.faction_content.bundle import (\n"
...
def _generated_manifest_content() -> str:
    ...
    return (
        ...
        "if record.execution_id in execution_record_id_set\n"
        "    )\n"
