...
AELDARI_AUTARCHS_DATASHEET_IDS = ("000000577", "000002759")
...
CHAOS_DAEMONS_SPLIT_SUPPORTED_SEMANTICS = (
    ...
    "rolls add authoritatively regenerated Blue or Brimstone models through validated "
    "battlefield placement, preserve distinct action and parent battle phase evidence for "
    "out-of-phase attacks, and dispatch per-model battlefield-placement reactions. The "
    "composition-driven handoff also runs after finalized non-attack destruction, waits for "
    "optional destruction reactions, never creates an empty unit, preserves Attached Unit "
    "identity and the original Starting Strength, and permits Split growth above Starting "
    "Strength. "
...
def _chaos_daemons_semantic_snapshot_markdown() -> list[str]:
    lines = [
        ...
        (
            ...
            "(../../data/army_lists/cavalcade-shadow-bloodthirster.json) is an unchanged "
            "eight-unit Strike Force across Be'lakor, Bloodthirster, Lord of Change, "
            "Plaguebearers, and Bloodcrushers. It reprices to 2,075 points under the July "
            "MFM and is correctly rejected as 75 points over the 2,000-point limit. Its "
            "exact production catalog is "
            ...
            "`SHADOW LEGION` keyword grant. The accepted Bloodcrushers, Bloodhunter, and "
            "Be'lakor geometry records are applied at runtime. Only the Bloodthirster, Lord "
            "of Change, Plaguebearers, and Plagueridden representative heights remain "
            "`NEEDS_REVIEW`; those four diagnostics make the capability manifest honestly "
            "withhold `PHYSICALLY_PLAYABLE`. The July "
            "MFM evidence proves the mustering failure, while the Cavalcade of Chaos and "
            "Shadow Legion runtime bundles, selected datasheet abilities, and two "
            "Apocalyptic Steeds assignments still have active semantic runtime evidence. "
            "This selected-component evidence does not claim "
    ...
    return (
        ...
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                ...
                "Instrument of Chaos charge modifier, plus Bane of Cowards Desperate "
                "Escape test and Battle-shocked roll modifier semantics, are consumed."
            ),
            semantics_needed="None.",
        ...
        DatasheetGroupReviewRow(
            ...
            ir_coverage="All consumed",
            supported_semantics=(
                "Deep Strike, Deadly Demise descriptor evidence, Murderlust Advance-and-Charge, "
                "The Shadow of Chaos, Greater Daemon of Khorne Shadow aura, and Rage Embodied "
                "melee Attacks aura are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
        ),
...
def _chaos_daemons_nurgle_review_rows() -> tuple[DatasheetGroupReviewRow, ...]:
    return (
        ...
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                "Deep Strike, The Shadow of Chaos, Daemonic Icon Leadership, and "
                "Instrument of Chaos charge modifier semantics, plus Death's Heads "
                "post-shoot tracked target and friendly Nurgle Daemons wound reroll "
                "semantics, are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
        ...
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                ...
                "aura, Deluge Move/OC aura, and targeted damage bonus semantics are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
        ),
    ...
    return (
        ...
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                ...
                "test and modifier semantics are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
        ),
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                ...
                "Damage modifier semantics are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
        ),
        ...
        DatasheetGroupReviewRow(
            ...
            supported_semantics=(
                ...
                "structured paths; Eternal Dance fight-start selected-enemy wound modifier "
                "semantics are consumed."
            ),
            semantics_needed="None.",
            catalog_blockers="Representative height remains unreviewed outside this report.",
