...
| 14H | Complete | Advanced transport, attached-unit formation, reserve/repositioning, and aircraft cutover |
...
structured Leader/Support declarations and catalog attachment eligibility; it
...
evidence used by attacks, healing, revival, persisting effects, and stratagem
target canonicalization. Broader real-faction Leader/Support eligibility data
ingestion remains future source/catalog work, not a Phase 14H runtime blocker.
