...
- Shock Disembark tests cover source eligibility, Advance-only Transport movement, canonical attached enemy identity, 3" placement, exact start-engagement snapshot and preservation, malformed snapshot rejection before queue pop, one-at-a-time opponent Fight activation without a pass, canonical selected-to-fight hooks, completion, event/replay restore, determinism, and both-viewer adapter projection/event visibility;
