...
alive Leader/Support/character Toughness. The open blockers are still Combat
Disembark's dedicated source path, runtime army-list Attached Unit formation
plus healing/revival, full repositioned-unit effect persistence, and the
remaining setup-time reserve/transport declarations.
