...
from ._artifacts import (
    AeldariShroudWraithRuleIrArtifactError,
    AeldariShroudWraithRuleIrPackageArtifact,
    aeldari_shroud_wraith_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> AeldariShroudWraithRuleIrPackageArtifact:
    try:
    ...
    return aeldari_shroud_wraith_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[AeldariShroudWraithRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    aeldari_shroud_wraith_rule_ir_package_artifact_from_json_bytes(raw)
