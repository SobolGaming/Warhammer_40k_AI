...
LAYOUTS = (
    EventBattlefieldLayoutSource(
        ...
        terrain_area_specs=(
            ...
            ("7x11-5-attacker-home", FOOTPRINT_7X11_5, 21.09, 42.59, 180.0),
            ("10x2-5-attacker-midfield", FOOTPRINT_10X2_5, 24.02, 49.62, 0.0),
            ("6x4-attacker-west", FOOTPRINT_6X4, 3.02, 45.95, 0.0),
            ("6x2-east-midfield", FOOTPRINT_6X2, 32.74, 31.55, -8.0),
            ("6x4-east-midfield", FOOTPRINT_6X4, 29.08, 22.14, 82.0),
            (
        ...
        objective_terrain_area_specs=(
            ("attacker-home", "Attacker Home Objective", "attacker_home", 17.25, 49.25, ()),
            ("defender-home", "Defender Home Objective", "defender_home", 26.75, 10.75, ()),
            ("central-south", "South Central Objective", "central", 17.7, 23.6, ()),
            ("central-north", "North Central Objective", "central", 26.3, 36.4, ()),
            ("expansion-east", "East Expansion Objective", "expansion", 37.65, 41.4, ()),
            ("expansion-west", "West Expansion Objective", "expansion", 6.35, 18.6, ()),
        ),
    ),
    EventBattlefieldLayoutSource(
    ...
    EventBattlefieldLayoutSource(
        ...
        terrain_area_specs=(
            ...
            ("6x4-south-west-midfield", FOOTPRINT_6X4, 9.52, 24.32, -37.5),
            ("7x11-5-central-north-west", FOOTPRINT_7X11_5, 14.38, 32.25, 90.0),
        ...
        objective_terrain_area_specs=(
            ...
            ("defender-home", "Defender Home Objective", "defender_home", 37.55, 14.61, ()),
            (
                "central-north-west",
