...
from ._artifacts import (
    ...
    aeldari_autarchs_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> AeldariAutarchsRuleIrPackageArtifact:
    try:
        ...
        raise AeldariAutarchsRuleIrArtifactError(
            "Aeldari Autarchs generated RuleIR artifact could not be loaded."
        ) from exc
    return aeldari_autarchs_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[AeldariAutarchsRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    aeldari_autarchs_rule_ir_package_artifact_from_json_bytes(raw)
