...
from ._artifacts import (
    AeldariAspectWarriorsRuleIrArtifactError,
    AeldariAspectWarriorsRuleIrPackageArtifact,
    aeldari_aspect_warriors_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> AeldariAspectWarriorsRuleIrPackageArtifact:
    try:
        ...
        raise AeldariAspectWarriorsRuleIrArtifactError(
            "Aeldari Aspect Warrior generated RuleIR artifact could not be loaded."
        ) from exc
    return aeldari_aspect_warriors_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[AeldariAspectWarriorsRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    aeldari_aspect_warriors_rule_ir_package_artifact_from_json_bytes(raw)
