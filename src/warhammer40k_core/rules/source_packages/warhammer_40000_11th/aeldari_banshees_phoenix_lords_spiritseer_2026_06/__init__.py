...
from ._artifacts import (
    AeldariBansheesPhoenixLordsSpiritseerRuleIrArtifactError,
    AeldariBansheesPhoenixLordsSpiritseerRuleIrPackageArtifact,
    aeldari_banshees_phoenix_lords_spiritseer_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> AeldariBansheesPhoenixLordsSpiritseerRuleIrPackageArtifact:
    try:
        ...
        raise AeldariBansheesPhoenixLordsSpiritseerRuleIrArtifactError(
            "Aeldari generated RuleIR artifact could not be loaded."
        ) from exc
    return aeldari_banshees_phoenix_lords_spiritseer_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[AeldariBansheesPhoenixLordsSpiritseerRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    aeldari_banshees_phoenix_lords_spiritseer_rule_ir_package_artifact_from_json_bytes(raw)
