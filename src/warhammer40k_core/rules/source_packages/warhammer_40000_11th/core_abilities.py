        ...
        sorted(
            (
                ...
                SourceAbilityRow(
                    ...
                    trigger_kind="before_battle",
                    phase=None,
                    handler_id="core:leader",
                    required_keywords=("LEADER",),
                    datasheet_id="core-character-leader",
                ),
                SourceAbilityRow(
                    ability_id="core-support",
                    name="Support",
                    source_kind="datasheet",
                    source_id=f"{source_prefix}:support",
                    when_descriptor="declare battle formations",
                    effect_descriptor="support can attach to eligible bodyguard units",
                    restrictions_descriptor="datasheet support attachment list applies",
                    trigger_kind="before_battle",
                    phase=None,
                    handler_id="core:support",
                    required_keywords=("SUPPORT",),
