...
def core_stratagem_rows() -> tuple[SourceStratagemRow, ...]:
    ...
    return (
        SourceStratagemRow(
            ...
            target_descriptor="That unit or model.",
            effect_descriptor="reroll that dice roll",
            restrictions_descriptor="same stratagem and same targeted unit per phase",
            trigger_kind="after_dice_roll",
            phase=None,
            target_kind="friendly_unit",
            enumerable=True,
            target_policy_id="command_reroll_unit",
