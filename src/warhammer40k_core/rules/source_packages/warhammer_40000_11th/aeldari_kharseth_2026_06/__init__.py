...
from ._artifacts import (
    KharsethRuleIrArtifactError,
    KharsethRuleIrPackageArtifact,
    kharseth_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> KharsethRuleIrPackageArtifact:
    try:
        ...
        raise KharsethRuleIrArtifactError(
            "Kharseth generated RuleIR artifact could not be loaded."
        ) from exc
    return kharseth_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[KharsethRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    kharseth_rule_ir_package_artifact_from_json_bytes(raw)
