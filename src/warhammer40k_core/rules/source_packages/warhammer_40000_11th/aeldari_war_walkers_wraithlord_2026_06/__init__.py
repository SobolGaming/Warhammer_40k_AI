...
from ._artifacts import (
    AeldariWarWalkersWraithlordRuleIrArtifactError,
    AeldariWarWalkersWraithlordRuleIrPackageArtifact,
    aeldari_war_walkers_wraithlord_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> AeldariWarWalkersWraithlordRuleIrPackageArtifact:
    try:
        ...
        raise AeldariWarWalkersWraithlordRuleIrArtifactError(
            "Aeldari War Walkers/Wraithlord generated RuleIR artifact could not be loaded."
        ) from exc
    return aeldari_war_walkers_wraithlord_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[AeldariWarWalkersWraithlordRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    aeldari_war_walkers_wraithlord_rule_ir_package_artifact_from_json_bytes(raw)
