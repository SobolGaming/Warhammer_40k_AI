...
_FACTION_ROWS = _validate_unique_faction_rows(
    (
        ...
        _faction("Astra Militarum"),
        _faction("Adepta Sororitas"),
        _faction("Adeptus Mechanicus"),
        _faction("Imperial Knights"),
        _faction("Adeptus Custodes"),
        _faction("Imperial Agents"),
    )
)
...
_DETACHMENT_ROWS = _validate_detachment_rows(
    (
        ...
        _row("astra-militarum", "Armoured Infantry", "Take and Hold", 2),
        _row("astra-militarum", "Combined Arms", "Take and Hold", 3),
        _row("astra-militarum", "Grizzled Company", "Priority Assets", 3),
        _row("astra-militarum", "Hammer of the Emperor", "Purge the Foe", 2),
        _row("astra-militarum", "Mechanised Assault", "Purge the Foe", 2),
        _row("astra-militarum", "Recon Element", "Reconnaissance", 3),
        _row("astra-militarum", "Siege Regiment", "Disruption", 2),
        _row("astra-militarum", "Steel Hammer", "Purge the Foe", 2),
        _row(
            "adepta-sororitas",
        ...
        _row("adepta-sororitas", "Army of Faith", "Take and Hold", 2),
        _row("adepta-sororitas", "Bringers of Flame", "Purge the Foe", 3),
        _row("adepta-sororitas", "Champions of Faith", "Disruption", 2),
        _row("adepta-sororitas", "Hallowed Martyrs", "Priority Assets", 3),
        _row("adepta-sororitas", "Penitent Host", "Take and Hold", 2),
        _row(
            "adeptus-mechanicus",
            "Cohort Acquisitus",
            "Reconnaissance",
        ...
        _row("adeptus-mechanicus", "Cohort Cybernetica", "Take and Hold", 2),
        _row("adeptus-mechanicus", "Data-psalm Conclave", "Disruption", 2),
        _row("adeptus-mechanicus", "Eradication Cohort", "Purge the Foe", 3),
        _row("adeptus-mechanicus", "Explorator Maniple", "Priority Assets", 2),
        _row("adeptus-mechanicus", "Haloscreed Battle Clade", "Purge the Foe", 3),
        _row("adeptus-mechanicus", "Rad-zone Corps", "Take and Hold", 2),
        _row("adeptus-mechanicus", "Skitarii Hunter Cohort", "Reconnaissance", 2),
        _row(
            "imperial-knights",
            "Dominus Foebreakers",
            "Purge the Foe",
        ...
        _row("imperial-knights", "Freeblade Company", "Purge the Foe", 3),
        _row("imperial-knights", "Gate Warden Lance", "Priority Assets", 2),
        _row("imperial-knights", "Questoris Companions", "Take and Hold", 3),
        _row("imperial-knights", "Spearhead-at-arms", "Reconnaissance", 2),
        _row("imperial-knights", "Valourstrike Lance", "Purge the Foe", 2),
        _row(
            "adeptus-custodes",
        ...
        _row("adeptus-custodes", "Auric Champions", "Priority Assets", 2),
        _row("adeptus-custodes", "Lions of the Emperor", "Disruption", 2),
        _row("adeptus-custodes", "Null Maiden Vigil", "Reconnaissance", 2),
        _row("adeptus-custodes", "Shield Host", "Purge the Foe", 2),
        _row("adeptus-custodes", "Solar Spearhead", "Take and Hold", 2),
        _row("adeptus-custodes", "Talons of the Emperor", "Take and Hold", 3),
        _row("imperial-agents", "Imperialis Fleet", "Disruption", 3),
        _row("imperial-agents", "Ordo Hereticus, Purgation Force", "Priority Assets", 3),
        _row("imperial-agents", "Ordo Malleus, Daemon Hunters", "Reconnaissance", 3),
        _row("imperial-agents", "Ordo Xenos, Alien Hunters", "Purge the Foe", 3),
        _row("imperial-agents", "Veiled Blade Elimination Force", "Purge the Foe", 3),
    ),
    _FACTION_ROWS,
)
