...
from ._artifacts import (
    CorsairVoidUnitsRuleIrArtifactError,
    CorsairVoidUnitsRuleIrPackageArtifact,
    corsair_void_units_rule_ir_package_artifact_from_json_bytes,
)
...
def _load_artifact() -> CorsairVoidUnitsRuleIrPackageArtifact:
    try:
        ...
        raise CorsairVoidUnitsRuleIrArtifactError(
            "Corsair void-unit generated RuleIR artifact could not be loaded."
        ) from exc
    return corsair_void_units_rule_ir_package_artifact_from_json_bytes(raw)


_ARTIFACT: Final[CorsairVoidUnitsRuleIrPackageArtifact] = _load_artifact()
...
def validate_generated_artifact_bytes(raw: bytes) -> None:
    corsair_void_units_rule_ir_package_artifact_from_json_bytes(raw)
