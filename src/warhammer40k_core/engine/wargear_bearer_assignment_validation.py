    ...
    *,
    ...
    for selection in selections:
        ...
        assignment_is_required = (
            ...
            and (model_count > 1 or selection.resolved_selection_count > 1)
        )
