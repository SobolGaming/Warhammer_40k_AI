...
if TYPE_CHECKING:
    ...
    from warhammer40k_core.engine.stratagems_effect_handlers import _apply_go_to_ground_handler, _apply_explosives_handler, apply_explosives_mortal_wound_feel_no_pain_decision, _emit_explosives_resolved, _apply_counteroffensive_handler, _apply_crushing_impact_handler, _apply_epic_challenge_handler, _apply_heroic_intervention_handler, _apply_stratagem_mortal_wounds, _heroic_intervention_reachable_target_distances, _enemy_unit_ids_for_player, _closest_unit_distance_inches
...
def _stratagem_unavailable_reason(
    *,
    ...
    if (
        record.definition.handler_id == CORE_HEROIC_INTERVENTION_HANDLER_ID
        and source_decision_result_id is not None
        and effect_selection is None
    ):
