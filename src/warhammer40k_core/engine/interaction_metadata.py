...
_FINITE_INTERACTION_SPECS = MappingProxyType(
    {
        ...
        "select_catalog_movement_end_target_effect": InteractionSpec(
            InteractionKind.ENTITY_SELECTION,
            ("target_unit",),
        ),
        ...
        "select_dice_extremum": InteractionSpec(InteractionKind.DICE_SELECTION, ("die",)),
        ...
        "select_core_ability_instance": InteractionSpec(InteractionKind.FINITE_OPTION_LIST),
