...
def _resolve_reinforcement_placement_submission(
    *,
    ...
    if (
        movement_state.active_selection is None
        or movement_state.active_selection.unit_instance_id != unit_instance_id
    ):
        raise GameLifecycleError("Reinforcement placement requires matching active selection.")
