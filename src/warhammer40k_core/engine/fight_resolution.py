...
from warhammer40k_core.engine.fight_weapon_selection import (
    MeleeTargetAllocation as MeleeTargetAllocation,
)
from warhammer40k_core.engine.fight_weapon_selection import (
    MeleeWeaponDeclaration as MeleeWeaponDeclaration,
)
from warhammer40k_core.engine.fight_weapon_selection import (
    available_melee_weapons_payloads as available_melee_weapons_payloads,
)
from warhammer40k_core.engine.fight_weapon_selection import (
    build_melee_declaration_request as build_melee_declaration_request,
)
from warhammer40k_core.engine.fight_weapon_selection import (
    melee_attack_sequence_from_proposal as melee_attack_sequence_from_proposal,
)
from warhammer40k_core.engine.fight_weapon_selection import (
...
class MeleeWeaponDeclarationPayload(TypedDict):
    ...
    selected_weapon_ability_ids: NotRequired[list[str]]
