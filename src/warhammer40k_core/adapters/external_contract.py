...
EXTERNAL_CONTRACT_VERSION = "20.0.0"
...
SESSION_COMMAND_RESULT_SCHEMA_VERSION = "session-command-result-v20-contract"
SESSION_COMMAND_ENVELOPE_SCHEMA_VERSION = "session-command-envelope-v2-weapon-instances"
SESSION_COMMAND_OUTCOME_SCHEMA_VERSION = "session-command-outcome-v20-contract"
SESSION_CREATE_SCHEMA_VERSION = "session-create-v4"
SESSION_METADATA_SCHEMA_VERSION = "session-metadata-v20-contract"
SESSION_PERSISTENCE_CONTRACT_VERSION = "20.0.0"
SESSION_PERSISTENCE_SCHEMA_VERSION = "session-persistence-v12-charge-rerolls"
