...
EXTERNAL_CONTRACT_VERSION = "5.0.0"
...
SESSION_COMMAND_RESULT_SCHEMA_VERSION = "session-command-result-v5-contract"
SESSION_COMMAND_ENVELOPE_SCHEMA_VERSION = "session-command-envelope-v1"
SESSION_COMMAND_OUTCOME_SCHEMA_VERSION = "session-command-outcome-v5-contract"
SESSION_CREATE_SCHEMA_VERSION = "session-create-v2"
SESSION_METADATA_SCHEMA_VERSION = "session-metadata-v5-contract"
SESSION_PROJECTION_SCHEMA_VERSION = "session-projection-v3-phase17n"
