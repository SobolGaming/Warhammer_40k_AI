...
def test_phase18e_server_api_smoke_exports_replay_and_schema_valid_payloads() -> None:
    ...
    assert initial_events["schema_version"] == "event-delta-v4-phase17n-step3"
    ...
    assert _field_object(identities, "contract_schema")["contract_version"] == "8.0.0"
...
def test_phase18e_command_result_schema_requires_accepted_commands_to_be_committed() -> None:
    ...
    example["schema_version"] = "session-command-result-v8-contract"
