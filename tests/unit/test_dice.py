...
def test_destruction_evidence_metadata_is_rng_history_neutral() -> None:
    base_request = _select_unit_request("decision-request-evidence")
    ...
    base_result = DecisionResult.for_request(
        result_id="decision-result-evidence",
