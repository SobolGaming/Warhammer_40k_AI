...
_LIFECYCLE_ROWS = step6g_lifecycle_certification_rows(STEP6G_DEFEND_THROUGH_FORWARD_MISSION_IDS)
_TACTICAL_ROWS = step6g_tactical_certification_rows(STEP6G_DEFEND_THROUGH_FORWARD_MISSION_IDS)
