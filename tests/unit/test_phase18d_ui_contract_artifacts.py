...
def test_session_metadata_contract_version_accepts_current_major_releases() -> None:
    ...
    compatible = {**_json_object(metadata), "server_contract_version": "34.0.0"}
