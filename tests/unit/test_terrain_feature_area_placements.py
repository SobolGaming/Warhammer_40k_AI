...
def test_source_terrain_transforms_publish_six_decimal_canonical_coordinates() -> None:
    ...
    assert canonical_terrain_area_transform_coordinate(31.088806397420253) == 31.0888064
    assert canonical_terrain_area_transform_coordinate(31.08880639742025) == 31.0888064
    assert all(
