...
| F-EVID-01 | 1 | Module status, source labels, execution classifications and component labels describe different facts with different denominators. | Q1. **FM-pre schema delivered** in [Q1_STATUS_ARTIFACT.md](factions/status/Q1_STATUS_ARTIFACT.md); live artifact remains FM0 |
...
| F-DOC-01 | 2 | Generated reports mix evidence layers; guides are hand-maintained. | Q1, D1. Q1 schema delivered; D1 generation remains FM0 |
