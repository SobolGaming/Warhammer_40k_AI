...
| Aeldari | Corsair Coterie | Relentless Raiders movement/charge completion mortal-wound hook plus Void Thieves sticky objective-control hook | Adapter contract, architecture, and generated matrix | Focused mustering, objective-control, movement-completion, turn-end, Stratagem-cost, and runtime-modifier tests | Full | Includes Veterans of the Void mustering, objective-control ownership checks after sticky states, D6 2+ into D3 mortal wounds for enemies ending Normal/Advance/Fall Back/Charge moves on controlled objectives, and Anhrathe sticky control. |
