...
| [Track U classification](factions/updates/README.md) | Pre-gate update classification, packet schema, and retention design; U2 grain, U3 classes, U4 layers, the data-first packet contract, and U7/U7a packaging windows are delivered; S4 tool, generator, emission, packets' live-contract rewrite, invalidation, inventory, and U8 remain FM0 |
