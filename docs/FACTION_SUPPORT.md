...
1. **Correct stale claims:** reconcile Acts of Faith turn timing, the Orks v946 refresh, changed costs/attachments, and conflicting coverage labels. The [Track U classification](factions/updates/U_CLASSIFICATION_SYSTEM.md) closes diff grain, impact classes and layer demotion; the [packet schema](factions/updates/U_PACKET_SCHEMA.md) closes the work those classes produce; the [Q1 status artifact](factions/status/Q1_STATUS_ARTIFACT.md) closes where those claims persist; [retention](factions/updates/U7_RETENTION.md) closes packaging windows and the U7a mechanism; the [runbook](factions/updates/U8_RUNBOOK.md) closes cadence, capture, rewrite, and Q6; the [Track D D3 draft](factions/contracts/D3_CONTRACT_REWRITES.md) closes how FM0 rewrites the live agent contract and who may amend the adapter contract. The S4 tool, packet generator, status generator, packaging inventory, CI, and live contract files remain FM0.
...
| [Track U classification](factions/updates/README.md) | Pre-gate update classification, packet schema, retention, and runbook; U1–U8 design is delivered; S4 tool, generators, emission, invalidation, inventory, and CI remain FM0 |
| [Track D D3 draft](factions/contracts/README.md) | Pre-gate live agent-contract rewrite and adapter-contract writer policy; live files, T6 deltas, and the U7a amendment remain FM0 |
