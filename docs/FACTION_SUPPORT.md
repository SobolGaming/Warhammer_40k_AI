...
| [Track U classification](factions/updates/README.md) | Pre-gate update classification, packet schema, retention, and runbook; U1–U8 design is delivered; S4 tool, generators, emission, live-contract rewrite, invalidation, inventory, and CI remain FM0 |
