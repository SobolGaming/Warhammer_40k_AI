...
- immediate selected-target mortal wounds, Feel No Pain continuations, conditional Battle-shock, relative next-phase expiry, and source-backed cumulative Battle-shock/Leadership test modifiers remain engine-owned and replay-safe;
