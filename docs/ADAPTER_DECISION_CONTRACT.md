...
- duplicate Spotted target, Battle-shocked Observer, FORTIFICATION Observer, duplicate Cabal model/ritual attempt, Lone Operative exclusion, stale, drifted, malformed, wrong-context, and closed-window submissions reject before mutation;
