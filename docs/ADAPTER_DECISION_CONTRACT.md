...
- `FightPhaseState`: replay-safe Fight phase state containing Start/Pile In/Fight/Consolidate/End step exposure, ordering bands, start-of-phase engagement eligibility, Fights First sources, activations, passes, and resolved fight interrupts.
