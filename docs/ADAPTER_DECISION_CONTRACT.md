...
- generic selected-target effect choices persist selected-target-gated generic RuleIR effects and consume them only through engine-owned attack hooks;
