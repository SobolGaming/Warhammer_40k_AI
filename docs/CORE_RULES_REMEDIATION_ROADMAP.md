...
| 4 | 22.03.01 Psychic Abilities with a Psychic Level | No per-PSYKER-rules-unit, per-phase same-ability-use ledger or restore validation exists. | Add `C22-02` / P22B. |
...
| 14 | Critical hit on 4+ when 5+ is normally required FAQ | A lowered threshold can make the attack hit, but critical status/effects remain restricted to an unmodified 6. | Add `C04-02` to P04. |
| 15 | Critical 4+ during Snap Shooting FAQ | Direct conflict: generic minimum-hit thresholds can lower Snap's unmodified-6 requirement. | Add `C04-03` to P04. |
...
P18D follows P18C and owns C18-04; P18E follows P18D and owns C18-05; P20 owns C18-06 together with
C20-01.
...
C01-03/P01C, C02-04/P02D, and C05-04/P05D. Existing future PRs are expanded atomically:
P14 adds C14-02; P12 adds C12-03; P04 adds C04-02 and C04-03 and widens C04-01; P11A adds C11-03;
...
- all 53 implementation remediation PRs and PFINAL merged, plus every
...
There are no routine source confirmations during the current 54-PR sequence.
