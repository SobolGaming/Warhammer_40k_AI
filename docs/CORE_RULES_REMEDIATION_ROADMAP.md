...
remain useful corroboration. App-data version 931, dated 2026-08-26, exposes
18.06 Assault Disembark Move and 18.07 Shock Disembark Move, and version 946,
dated 2026-09-02, exposes 18.04.01 Rapid Disembark And Limitations. The official
...
Disembark as new Core Rules concepts; the complete numbered statements are
available through the Game Datamissions App-data changelog.

This roadmap update records those three gaps but does not change the checked-in
P00 source-policy artifact. Before P18D, P18E, or the C18-06 portion of P20 pins
its implementation evidence, a later source-governance update must replace the
...
`S-MIRRORS` is the later source-governance update described above. It is a
documentation/evidence prerequisite, not a gameplay-remediation PR or a
closable implementation finding.
...
### Post-P18C Transport findings — C18-04, C18-05, C18-06

Status: Planned documentation only in PR #414. No P18C production, contract, source-package, or
generated-runtime scope is expanded by these findings.

Evidence and sequencing: Game Datamissions records 18.06 Assault Disembark Move and 18.07 Shock
Disembark Move in direct App-data version 931, dated 2026-08-26, and 18.04.01 Rapid Disembark And
Limitations in version 946, dated 2026-09-02. The official August 26 Universal Rules Updates v1.1
independently confirms that Assault and Shock Disembark are new Core Rules concepts. P18D follows
P18C and owns C18-04; P18E follows P18D and owns C18-05; P20 owns C18-06 together with C20-01.
...
explicitly prove C18-04, C18-05, and C18-06 closed and must compare co-versioned
...
- all 45 implementation remediation PRs and PFINAL merged, plus every
...
- PFINAL's committed cross-category dependency and regression audit finding no
  new gaps, explicitly closing C18-04/C18-05/C18-06, and closing `CAUDIT-01`.
...
There are no routine source confirmations during the current 46-PR sequence.
